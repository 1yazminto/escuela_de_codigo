...
1.Realiza las siguientes operaciones numéricas y calcula el valor final:
    ...
    a) (100/5^2 + 1) + 11 * 3 = (100/25+1)+11*3 =(4+1)+11*3=5+11*3=5+33=38 (valor 0.5)
   


    b) (18/9 + 24) – ( 5 * 4 – 3^3) =   (2+24)-(20-27)=26+7=33   (valor 0.5)
...
1. Menciona al menos 3 tipos de datos que existen: (valor 0.4)
    ...
    Respuesta: LOGICOS, NUMRERICOS, DE CARACTER
...
Llena la siguiente tabla:
    ...
    Correo electrónico:yazminto@hotmail.com                      alfanumerico
